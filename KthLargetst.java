...
class KthLargest {
    ...
    private Node insertNode(Node root, int num) {
        ...
        root.cnt++;    // need to suffciently understand why put this code on this line : my understanding is that it is postorder , this line where you do the root level operation
        return root;
    }
